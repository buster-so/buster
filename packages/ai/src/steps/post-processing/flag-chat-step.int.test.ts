    ...
    const mockConversationHistory: CoreMessage[] = [
        ...
        content: [
          {
            ...
            toolCallId: 'toolu_01KKXA1KUXcCAHjA2jAjfSXE',
            toolName: 'sequentialThinking',
            type: 'tool-call',
          },
        ],
        ...
        content: [
          {
            ...
            toolCallId: 'toolu_01QyPGts4d3WdGmFmrd5urVT',
            toolName: 'sequentialThinking',
            type: 'tool-call',
          },
        ],
      ...
      },
      {
        content: [
          {
            args: {},
            toolCallId: 'toolu_01T6RXZpViewbAVZWYD5YxRd',
        ...
        content: [
          {
            ...
            toolCallId: 'toolu_01JTGAQ7Pz8gT3SnRaUZttdF',
