...
--> statement-breakpoint
CREATE TABLE "github_integration_requests" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"organization_id" uuid NOT NULL,
...
ALTER TABLE "github_integration_requests" ADD CONSTRAINT "github_integration_requests_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "github_integration_requests" ADD CONSTRAINT "github_integration_requests_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "github_integration_requests_org_user_key" ON "github_integration_requests" USING btree ("organization_id","user_id");--> statement-breakpoint
CREATE INDEX "idx_github_integration_requests_org_id" ON "github_integration_requests" USING btree ("organization_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "idx_github_integration_requests_github_login" ON "github_integration_requests" USING btree ("github_login" text_ops);--> statement-breakpoint
