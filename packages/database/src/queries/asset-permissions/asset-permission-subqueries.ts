...
// Library-aware versions of subqueries for use in library-specific contexts
// These versions include library filtering for parent assets

// Library-aware direct assets (assets that are directly in the user's library)
export const libraryPermissionedReportFiles = (organizationId: string, userId: string) =>
  db
    .select({
      assetId: reportFiles.id,
      assetType: sql`'report_file'::asset_type_enum`.as('assetType'),
...
export const libraryPermissionedMetricFiles = (organizationId: string, userId: string) =>
  db
    .select({
      assetId: metricFiles.id,
      assetType: sql`'metric_file'::asset_type_enum`.as('assetType'),
...
export const libraryPermissionedDashboardFiles = (organizationId: string, userId: string) =>
  db
    .select({
      assetId: dashboardFiles.id,
      assetType: sql`'dashboard_file'::asset_type_enum`.as('assetType'),
...
export const libraryPermissionedChats = (organizationId: string, userId: string) =>
  db
    .select({
      assetId: chats.id,
      assetType: sql`'chat'::asset_type_enum`.as('assetType'),
...
export const libraryPermissionedCollections = (organizationId: string, userId: string) =>
  db
    .select({
      assetId: collections.id,
      assetType: sql`'collection'::asset_type_enum`.as('assetType'),
...
// Library-aware child assets (child assets whose parents are in the user's library)

export const libraryChildMetricsFromDashboards = (organizationId: string, userId: string) =>
  db
    .select({
      assetId: metricFiles.id,
      assetType: sql`'metric_file'::asset_type_enum`.as('assetType'),
...
export const libraryChildMetricsFromReports = (organizationId: string, userId: string) =>
  db
    .select({
      assetId: metricFiles.id,
      assetType: sql`'metric_file'::asset_type_enum`.as('assetType'),
...
export const libraryChildMetricsFromChats = (organizationId: string, userId: string) =>
  db
    .select({
      assetId: metricFiles.id,
      assetType: sql`'metric_file'::asset_type_enum`.as('assetType'),
...
export const libraryChildDashboardsFromChats = (organizationId: string, userId: string) =>
  db
    .select({
      assetId: dashboardFiles.id,
      assetType: sql`'dashboard_file'::asset_type_enum`.as('assetType'),
...
export const libraryChildReportsFromChats = (organizationId: string, userId: string) =>
  db
    .select({
      assetId: reportFiles.id,
      assetType: sql`'report_file'::asset_type_enum`.as('assetType'),
...
export const libraryChildMetricsFromCollections = (organizationId: string, userId: string) =>
  db
    .select({
      assetId: metricFiles.id,
      assetType: sql`'metric_file'::asset_type_enum`.as('assetType'),
...
export const libraryChildDashboardsFromCollections = (organizationId: string, userId: string) =>
  db
    .select({
      assetId: dashboardFiles.id,
      assetType: sql`'dashboard_file'::asset_type_enum`.as('assetType'),
...
export const libraryChildReportsFromCollections = (organizationId: string, userId: string) =>
  db
    .select({
      assetId: reportFiles.id,
      assetType: sql`'report_file'::asset_type_enum`.as('assetType'),
...
export const libraryChildChatsFromCollections = (organizationId: string, userId: string) =>
  db
    .select({
      assetId: chats.id,
      assetType: sql`'chat'::asset_type_enum`.as('assetType'),
