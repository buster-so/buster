  ...
  return (
    ...
    >
      <div className="bg-muted/50 relative rounded-md group">
        <pre className="overflow-x-auto p-2 font-mono text-[15px] leading-[1.5] [tab-size:2] print:break-inside-avoid">
          <code>{props.children}</code>
        </pre>

        <div
          className="absolute top-1 right-1 z-10 flex gap-0.5 select-none opacity-0 group-hover:opacity-100 transition-opacity duration-200"
