...
export const BarChartPropsSchema = z.object({
  // Required for Bar
  barAndLineAxis: BarAndLineAxisSchema.optional(),
  // OPTIONAL: default: vertical (column chart)
  barLayout: z.enum(['horizontal', 'vertical']).default('vertical').optional(),
  // OPTIONAL
  barSortBy: BarSortBySchema.optional(),
  ...
  barShowTotalAtTop: z.boolean().default(false).optional()
});
